...
┃ ◉ .audiomack - Download audio from Audiomack (search or direct URL)
...
┃ ◉ .sessionmanager status - View session overview (Creator only)
┃ ◉ .sessionmanager restart <sessionId> - Restart session (Creator only)
┃ ◉ .sessionmanager enable <sessionId> - Enable session (Creator only)
┃ ◉ .sessionmanager disable <sessionId> - Disable session (Creator only)
┃ ◉ .sessionmanager broadcast <message> - Send to all sessions (Creator only)
┃ ◉ .sessions - Session management alias (Creator only)
